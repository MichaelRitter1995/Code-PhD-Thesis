...
ID_list <- data.frame(c("GB_STX1", "GB_STX2", "GB_STX3", "N21_2972", "GB_STX4", "GB_STX6", "GB_STX7"))
...
list_of_dataframes = lapply(ID_list[, 1],
                            function (x) {
                              ...
                              x1 <- readRDS(paste0("/omics/groups/OE0146/internal/Christina/Visium_seq/analysis/GBM/", sample_name, "/CNV_SPATA2/infercnv-obj.RDS"))
